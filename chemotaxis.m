function [bact]=chemotaxis(bacteria,prob,nc)
[f,c]=size(bacteria);
var=varNumber(prob);
angulos=zeros(var);
...
factorE=1.75;
        for b=1:f  
         ...
         % vastago=bact1+angulos(1)*(bact2-bact3);
           ...
           %vastago2=evaluations(vastago,prob);
           ...
           %end
               ...
               newbacteria=evaluations(newbacteria,prob);
              ...
              bacteria=sortBacteria(bacteria,prob);
        end 
bact=bacteria;
